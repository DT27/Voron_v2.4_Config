...
klipperCfgPath = '/home/voron/printer_data/config/'

### Path to your Klipper folder, by default that is '~/klipper'
klipper_folder= Path('/home/voron/klipper')

### Path to your Moonraker folder,by default that is '~/moonraker'
moonraker_folder= Path('/home/voron/moonraker')

### Path to your Mainsail folder, by default that is '~/mainsail'
mainsail_folder= Path('/home/voron/mainsail/.version')

### Path to your Fluidd folder, by default that is '~/fluidd'
fluidd_folder= Path('/home/voron/fluidd/.version')

### Path to your config backup repo folder
gitRepoPath = '/home/voron/klipper_cfg_backup/Voron_v2.4_Config/'
...
def copyLatestFiles():
    os.chdir('/home/voron/klipper_cfg_backup/')
